<?php include_once("encabezado.php"); ?>
  ...
  <tbody>
    ...
    for($i=2; $i<count($datos['archivos']); $i++){
      ...
      if (file_exists($carpeta)) {
        ...
        print "<td class='text-start'><a href='".RUTA."tableroMecanico/mostrarImagen/".$datos["data"]["id"]."/".$i."'>";
  ...
  <a href="<?php print RUTA.'tableroMecanico/mostrar/'.$datos["data"]['idOrdenReparacion'];?>" class="btn btn-success">
  Regresar</a>
