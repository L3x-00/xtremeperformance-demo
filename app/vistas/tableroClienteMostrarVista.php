...
<div class="tab-content" id="ordenReparacion">
  ...
  <tbody>
    ...
    for($i=0; $i<count($datos['seguimientos']); $i++){
      ...
      print "<td><a href='".RUTA."tableroCliente/desplegarSeguimiento/".$datos["seguimientos"][$i]["id"]."' class='btn btn-warning'>Mostrar</a></td>";
      print "</tr>";
    }
    ?>
  </tbody>
    ...
    <div class="form-group text-start">
      ...
      <a href="<?php print RUTA; ?>tableroCliente" class="btn btn-info">Regresar</a>
    </div>
