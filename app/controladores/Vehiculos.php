...
class Vehiculos extends Controlador
{
  ...
  public function exportarCsv(): void
  {
    ...
    // Quitamos 'Color' y 'Cliente ID' para igualar a la tabla web
    fputcsv($out, ['ID', 'Marca', 'Modelo', 'Año', 'Placas']);
  ...
  public function exportarPdf(): void
  {
    ...
    // Quitamos 'Color' de las cabeceras
    $headers = ['ID', 'Marca', 'Modelo', 'Año', 'Placas'];
    $data = [];
